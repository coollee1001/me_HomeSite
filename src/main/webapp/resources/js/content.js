    ...
    set:function(str,data){
        ...
        for(var i=0; i<data.length; i++){
            ...
            for(var r=0; r<data[i].list.length; r++){
                ...
                $('<li><a href="'+data[i].list[r].link+'"><span style="background-image:url('+data[i].list[r].image+');">'+data[i].list[r].title+'</span></a></li>').appendTo(obj.find(">ul>li").eq(i).find(">.layout>.midd>ul"));
            }
        }
